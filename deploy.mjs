...
for (const vault of vaults) {
	...
	const dest = join(vault, ".obsidian", "plugins", "powerconnect");
...
console.log(deployed ? `Done. Reload Obsidian (Ctrl+R) and enable "Power Connect" if it isn't enabled yet.` : "Nothing deployed.");
